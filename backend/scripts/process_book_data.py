...
def main():
    # When running from backend as a module (python -m scripts.process_book_data),
    # the current working directory is the project root (humanoid-robotics-book)
    # So we use the current working directory as the book path
